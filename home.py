...
#button
std_login_btn=Button(master,image=sn_img,width=255,height=40,relief= FLAT, font=('arial',14,'bold'), bg='#00437c', fg='white',activebackground='#00437c', command=goto_login)
std_login_btn.place(x=187,y=300)


login_btn=Button(master,image=ca_img,width=255,height=40,relief= FLAT,border=0, font=('arial',14,'bold'), bg='#00437c', fg='white',activebackground='#00437c',command=goto_sign)
